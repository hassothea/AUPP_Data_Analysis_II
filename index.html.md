---
title: "[**INS-605: Data Analysis II**]{.white} ![](./img/AUPP_Logo.png){width=45pt}"
author: "[[HAS Sothea, PhD](https://hassothea.github.io/)]{.white}"
format: 
  html:
    theme: cosmo       # Use a standard website theme, not a slide theme
    toc: true          # Enable a standard table of contents
    css: [styles.css]  
    keep-md: true     
website:
  back-to-top-navigation: true
  page-navigation: true
  site-url: https://hassothea.github.io/Data_Analysis_II_AUPP
date: 08/17/2026
title-block-banner: "#345a8b"
linestretch: 2.25
---
...
|:-------------------------------|:----:|:---------:|:------:|
| Review & Advanced Data Wrangling | Lab1 | Solution1 | ...Loading |
