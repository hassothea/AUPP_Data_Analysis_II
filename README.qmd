---
title: "**INF-604: Data Analysis** ![](./Slides/img/AUPP_Logo.png#right){width=45pt}"
title-block-style: manuscript
author: <a href="https://hassothea.github.io/">HAS Sothea, PhD</a>
website:
  back-to-top-navigation: true
  page-navigation: true
  site-url: https://hassothea.github.io/Data_Analytics_AUPP
date: 01/17/2025
toc: true
title-block-banner: "./Slides/img/bg.jpg"
linestretch: 2.25
format: gfm
---
...
> You are free you use your favorite programming language [![](./Slides/img/python.png){width=30px style="position: relative; bottom: 0px"}](https://www.python.org/){target="_blank"} `Python` or [![](./Slides/img/R_logo.png){width=30px style="position: relative; bottom: 0px"}](https://www.r-project.org/){target="_blank"} .

::: {.panel-tabset}
## `Python`

- [![](./Slides/img/jupyter.png){width=30px style="position: relative; bottom: 0px"} Jupyter Notebook](https://docs.jupyter.org/en/latest/){target="_blank"} 
- [![](./Slides/img/colab.png){width=30px style="position: relative; bottom: 0px"} Google colab](https://colab.research.google.com/){target="_blank"}
- [![](./Slides/img/plt_logo.png){width=35px style="position: relative; bottom: 0px"} Matplotlib](https://matplotlib.org/){target="_blank"}
- [![](./Slides/img/sns_logo.svg){width=30px style="position: relative; bottom: 0px"} Seaborn](https://seaborn.pydata.org/){target="_blank"}

## `R`

- [![](./Slides/img/quarto_logo.png){width=60px style="position: relative; bottom: 0px"} Rmarkdown/Quarto](https://quarto.org/){target="_blank"}
- [![](./Slides/img/posit_logo.png){width=25px style="position: relative; bottom: 0px"} Posit cloud](https://ggplot2.tidyverse.org/){target="_blank"}
- [![](./Slides/img/ggplot_logo.png){width=27px style="position: relative; bottom: 0px"} Ggplot2](https://ggplot2.tidyverse.org/){target="_blank"}
- [![](./Slides/img/tidyverse_logo.png){width=30px style="position: relative; bottom: 0px"} Tidyverse](https://www.tidyverse.org/){target="_blank"}
